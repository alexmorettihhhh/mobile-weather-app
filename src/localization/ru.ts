export const ru = {
  ...
  weather: {
    ...
    patchyRainNearby: 'Небольшой дождь поблизости',
    overcast: 'Облачно',
  },
  search: {
  ...
  interactive: {
    ...
    cloudSimulator: {
      ...
      instructions: [
        ...
        'Наблюдайте за процессом конденсации и формирования облаков',
  ...
  location: {
    success: 'Местоположение найдено',
    cached: 'Используется сохраненное местоположение',
    permissionDenied: 'Доступ к местоположению запрещен',
    disabled: 'Службы геолокации отключены',
    noInternet: 'Нет подключения к интернету',
    timeout: 'Истекло время запроса местоположения',
    error: 'Ошибка получения местоположения',
    unknown: 'Статус местоположения неизвестен',
  ...
  partlyCloudy: 'Частично облачно',
  patchyRainNearby: 'Небольшой дождь поблизости',
  rainFormation: 'Как образуется дождь?',
  thunderSound: 'Почему гремит гром?',
  snowflakeShape: 'Почему снежинки шестиугольные?',
  rainbowFormation: 'Как образуется радуга?',
  windCreation: 'Как возникает ветер?',
  humidityFacts: 'Что такое влажность?',
  tornadoFormation: 'Как образуются торнадо?',
  auroraBorealis: 'Что такое северное сияние?',
  cloudTypes: 'Типы облаков',
  pressureEffects: 'Влияние давления',
  lightningFacts: 'Факты о молниях',
  hurricaneEye: 'Глаз урагана',
  fogFormation: 'Как образуется туман?',
  rainSmell: 'Какой запах после дождя?',
  extremeWeather: 'Рекорды экстремальной погоды?',
  weatherSatellites: 'Метеорологические спутники?',
  climateZones: 'Климатические зоны?',
  weatherPrediction: 'История прогнозов погоды?',
}; 